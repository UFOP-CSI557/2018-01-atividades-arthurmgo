...
//        System.out.println(populacao.getIndividuos().get(0).getVariaveis());
        ...
        return new Dados(populacao.getIndividuos().get(populacao.getTamanho() - 1).getFuncaoObjetivo(),populacao.getIndividuos().get(0).getFuncaoObjetivo());
